...
<body>
    ...
    <main>
        <div class="Form-container">
	        ...
	        ResultSet r = ArticuloDAO.mostrarArticuloPorId(id);
	        while(r.next()){
	        
	        %>
            <form action="ejecutarEditar.jsp" method="get" id="form" title="form">
                    <label for="nombre">Nombre: </label>
                        <input type="text" id="nombre" class="inputA" placeholder="Escribe tu nombre" maxlength="30" minlength="3" required name="nombre" value="<%=r.getString("nombre")%>">
                    <label for="destino">Destino: </label>
                        <input type="text" id="destino "name="destino" value="<%=r.getString("destino")%>">
                    <label for="viajeros">Viajeros: </label>
                        <textarea name="viajeros" id="viajeros" cols="30" rows="10" class="inputB" placeholder="Lugas dónde te gustaría ir"><%=r.getString("viajeros")%></textarea>
                    	<input type="hidden" name="id" value="<%=r.getString("id")%>">
                    <label for=""></label>
                        <input type="submit" value="Editar articulo" class="inputD">
            </form>
            <% } %>
        </div>
    </main>

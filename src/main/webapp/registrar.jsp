...
<body>
	...
	<main>
		<div class="Form-container">
            <h1>Guardando art�culo</h1>
            <%
            String nombre, destino, viajeros;
            titulo = request.getParameter("nombre");
            lenguaje = request.getParameter("destino");
            contenido = request.getParameter("viajeros");
            out.print(nombre);
            out.print(destino);
            out.print(viajeros);
            ArticuloVO arti = new ArticuloVO(nombre, destino, viajeros);
